...
- Be specific when describing your project idea
- Include key requirements and constraints
- Mention target audience or use cases
- Ask follow-up questions if the plan needs adjustment
- Reference existing similar products for context
...
- Database persistence for saved plans
...
If you have questions or need help, feel free to reach out to the team!
- Node.js 18+
- npm
